...
@Remark  :
 *************************************************************************/
void* MyMem_Malloc(unsigned long ulSize, const char* szFile, int nLine);
...
@Remark  :
*************************************************************************/
void* MyMem_Realloc(void* addr, unsigned long ulSize, const char* szFile, int nLine);
